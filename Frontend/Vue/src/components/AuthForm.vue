...
.input:hover {
  box-shadow: 0px 0px 30px -1px rgba(217, 217, 217, 0.84);
  border-color: transparent;
}

.input:focus {
  box-shadow: 0px 0px 15px -1px rgba(217, 217, 217, 0.84);
  border-color: transparent;
}
...
.link-section-link {
  ...
  -o-transition: all 0.4s;
  -moz-transition: all 0.4s;
  background: linear-gradient(to right, #ea05e2, #5e21e3);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  background-clip: text;
  color: transparent;
  border-bottom: 1px solid #ea05e2;
}
...
.link-section-link:hover {
  background: linear-gradient(to right, #ea05e2, #e321c6);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  background-clip: text;
  color: transparent;
